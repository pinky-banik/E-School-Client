  ...
  <>
        ...
        <li><ToggoleButton/></li>
        {
          ...
          <div className='lg:flex justify-center items-center'>
            ...
            <Link to ="/profile"><button className='mx-auto w-full text-center my-1 hover:bg-gray-200 focus:bg-secondary focus-visible:text-white p-2 rounded-lg'>My Profile</button></Link>
