...
const Blog = () => {
  return (
    <div className="w-3/4 mx-auto py-10 gap-10 flex-col flex ">
      <h1 className="text-center font-bold text-primary text-4xl py-5 ">
        Blog
      </h1>
      ...
      <div className="p-5 py-10 shadow-2xl  rounded-xl">
        <h1 className="text-primary py-5 text-2xl  font-bold">
          Why are you using firebase? What other options do you have to
          implement authentication?
        </h1>
        <p className="text-gray-500 text-start">
          <strong>Why I am using firebase : </strong> <br />
          ...
          <strong className="my-5">
            The other options I have to implement Authentication :{" "}
          </strong>
          <br />
      ...
      <div className="p-5 py-10 shadow-2xl rounded-xl">
        ...
        <p className="text-gray-500">
          What is this node? Image result htmlFor What is Node? How does Node
          work? Node. js is an open-source, cross-platform JavaScript runtime
          environment and library htmlFor running web applications outside the
          client's browser.
          <br />
          <br />
